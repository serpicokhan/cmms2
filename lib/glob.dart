...
class ServerStatus{
  ...
  static const String ServerAddress="172.17.153.145:8000";
  static var priority = [
    '',
    'خیلی زیاد',
...
class MaintenanceType {
  ...
  final response = await http
      .get(Uri.parse("http://172.17.153.145:8000/api/v1/mt/"));

  if (response.statusCode == 200) {
      List jsonResponse = json.decode(utf8.decode(response.bodyBytes));
      return jsonResponse.map((job) => new MaintenanceType.fromJson(job)).toList();
    } else {
